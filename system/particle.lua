...
function ShortEmitter:initialise(emitterFile,timeFrame)
	if emitterFile == nil then return end 													-- so it can operate as a superclass
...
function ShortEmitter:timeOut()
	self:removeSelf() 																		-- stop after timeout
end 
...
function LoopingShortEmitter:initialise(emitterFile,timeFrame)
	ShortEmitter.initialise(self,emitterFile,timeFrame) 									-- call superclass
